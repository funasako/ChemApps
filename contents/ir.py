...
if 'multi_page' not in st.session_state:
    st.set_page_config(page_title="IR | JASCO Spectra File to Excel", page_icon=":bar_chart:", )
...
st.markdown(":red[対応フォーマット：日本分光（JASCO）]")
st.write("")
...
if uploaded_files:
    ...
    file_name = f"{current_date}_IR_{current_time}.xlsx"
